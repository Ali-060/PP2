...
pygame.display.set_icon(pygame.image.load(r'RACE/images/icon.png'))
pygame.display.set_caption("Crazy Racing")

car = [
    pygame.image.load(r'RACE/images/car1.png'), 
    pygame.image.load(r'RACE/images/car2.png'),
]
car = [
...
coin = pygame.image.load(r'RACE/images/coin.png')
coin = pygame.transform.scale(coin, (70, 70))

road = pygame.image.load(r'RACE/images/road.png')
road = pygame.transform.scale(road, (700, 700))

dark = pygame.image.load(r'RACE/images/dark.png')
